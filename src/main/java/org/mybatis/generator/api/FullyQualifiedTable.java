...
public class FullyQualifiedTable {
    ...
    public String getDomainObjectName() {
        if (stringHasValue(domainObjectName)) {
            ...
            return getCamelCaseString(resetTableNameIfIgnorePrefix(runtimeTableName), true);
        } else {
            return getCamelCaseString(resetTableNameIfIgnorePrefix(introspectedTableName), true);
        }
    }
    
    private String resetTableNameIfIgnorePrefix(String tableName) {
    	if(stringHasValue(ignoreTablePrefix) && tableName.startsWith(ignoreTablePrefix)){
			return tableName.substring(ignoreTablePrefix.length());
		}
    	return tableName;
    }
	...
	/**
	 * @param ignoreTablePrefix value to be assigned to property ignoreTablePrefix
	 */
