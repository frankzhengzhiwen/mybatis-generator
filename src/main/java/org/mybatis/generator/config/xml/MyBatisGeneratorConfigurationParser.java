...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseTable(Context context, Node node) {
        ...
        String ignoreTablePrefix = attributes.getProperty("ignoreTablePrefix"); //$NON-NLS-1$
        ...
        if (stringHasValue(ignoreTablePrefix)) {
        	tc.setIgnoreTablePrefix(ignoreTablePrefix);
        }
